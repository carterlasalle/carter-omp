...
from carter_omp.sandbox import Workspace

if TYPE_CHECKING:
    from carter_omp.worker import ReleaseTaskContext
...
def _load(name: str) -> str:
    return resources.files("carter_omp.prompts").joinpath(name).read_text(encoding="utf-8")
...
def dirty_state_reminder(
    *,
    ...
    leaves changes behind that carter-omp would otherwise discard. The summary
