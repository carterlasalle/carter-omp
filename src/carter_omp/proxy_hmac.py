"""Shared HMAC signing/verification for the carter-omp ↔ github-proxy channel.

Carter-Omp signs every request to github-proxy with an HMAC-SHA256 over
...
# Headers on every carter-omp→github-proxy request.
HEADER_TIMESTAMP = "X-CarterOmp-Timestamp"  # unix seconds, integer string
HEADER_SIGNATURE = "X-CarterOmp-Sig"  # hex-encoded HMAC-SHA256
HEADER_RUN_TOKEN = "X-CarterOmp-Run-Token"  # short-lived per-run authorization token
