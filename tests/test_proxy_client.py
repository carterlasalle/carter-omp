...
from carter_omp.git_ops import HeadDriftError
...
from carter_omp.proxy_hmac import HEADER_RUN_TOKEN, HEADER_SIGNATURE, HEADER_TIMESTAMP, sign, verify
...
async def test_round_trip_all_endpoints(round_trip_app) -> None:
    ...
    assert await client.get_authenticated_login() == "carter_omp-bot"
    ...
    assert existing_pr.author == "carter_omp-bot"
    ...
    async with httpx.AsyncClient(
        ...
        resp = await client.post(
            ...
            headers={
                ...
                HEADER_RUN_TOKEN: _test_run_token(),
...
def test_proxy_git_transport_push_slot_uid_body() -> None:
    ...
    def handler(request: httpx.Request) -> httpx.Response:
        ...
        return httpx.Response(200, json={"head": "abc123", "branch": "carter-omp/abc/feat"})
